...
## Woensdag
Samen met storm en Jarno aan het automatische bwa-mem commando gewerkt dit duurde lang vanwege problemen in het automatiseren. 

### BWA-MEM mapping
*uitvoering hiervan was na het trimmen van de data
BWA-MEM code van storm yarno floris en ik.
```{r}
...
Het opvallende hier is dat er een piek aan het begin bij circa 10 readlengt. dit hoort niet te kunnen aangezien hij alle reads onder 40 in lengte had moeten verwijderen. 
