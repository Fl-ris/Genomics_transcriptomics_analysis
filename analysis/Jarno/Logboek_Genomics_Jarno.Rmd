...
## Alleen in zetten wat relevant is voor ons onderzoek
...
# Aligning Data experiment - Optioneel, uitkomst niet verder gebruikt

## **Bwa mem 2 test voor 1 file**

BWA-MEM2 wordt gebruikt om zowel DNA- als RNA-reads te aligneren met een referentiegenoom. Het kan korte en middellange DNA- of RNA-reads alignen. Er zijn verschillende manieren waar dit voor gebruikt kan worden zoals, Whole genome sequencing, Exoomsequencing en RNA-seq. Voor ons is Whole genome sequencing interresant dit is omdat hierbij de genomen worden gescand en dan vergeleken met het gekozen referentie genoom (in ons geval GRCm39 uitgegeven op 22 - 07 -2020) dit om genetische variaties te identificeren.\
...
geindexeerd en gesorteerd + bam mee maken
...
Er zijn hier een paar verschillen te zien in vergelijking met de vorige trimming run. Er zijn 4 uitkomsten in de output. Forward en Reverse + unpaired en paired, verder is er gekeken naar de adapters. De sliding window is echter hetzelfde gebleven. Ook de threads zijn verhoogd van 16 naar 80 dit om de data nog sneller te verwerken.
