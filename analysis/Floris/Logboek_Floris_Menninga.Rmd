...
De volgende onderzoeksvraag is geformuleerd voor het genomics onderzoek:
...
Het format is aangegeven met "-O BAM"
...
Met samtools markdup worden duplicaten gemarkeerd. Met het "-r" argument worden deze 
verwijderd en met "-s" worden statistieken over de data en uitgevoerde handelingen. 
