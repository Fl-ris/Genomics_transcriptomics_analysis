...
Met de formule P = 10\^(-Q/10) kan de kans uitgerekend worden dat de variant niet echt aanwezig is. p = probability.
...
Het maken van de mm39 database ging niet zonder problemen, eerst vereiste het programma bestaden die niet aagegeven waren op de website van SnpEff.
...
Daarna gaf SnpEff een foutmelding over een missend CDS bestand.
Deze melding kan genegeerd worden met de flag "-"
