...
│   ├── mm39.fa
│   ├── protein.fa
│   ├── sequence.NC_000067.7.bin
│   ├── sequence.NC_000068.8.bin
│   ├── sequence.NC_000069.7.bin
│   ├── sequence.NC_000070.7.bin
│   ├── sequence.NC_000071.7.bin
│   ├── sequence.NC_000072.7.bin
│   ├── sequence.NC_000073.7.bin
│   ├── sequence.NC_000074.7.bin
│   ├── sequence.NC_000075.7.bin
│   ├── sequence.NC_000076.7.bin
│   ├── sequence.NC_000077.7.bin
│   ├── sequence.NC_000078.7.bin
│   ├── sequence.NC_000079.7.bin
│   ├── sequence.NC_000080.7.bin
│   ├── sequence.NC_000081.7.bin
│   ├── sequence.NC_000082.7.bin
│   ├── sequence.NC_000083.7.bin
│   ├── sequence.NC_000084.7.bin
│   ├── sequence.NC_000085.7.bin
│   ├── sequence.NC_000086.8.bin
│   ├── sequence.NC_000087.8.bin
│   ├── sequence.bin
│   ├── sequences.fa
│   ├── snpEff_genes.txt
│   ├── snpEff_summary.html
...
```{r venn diagram test, eval=FALSE}

# Todo:
# DF met kolomen maken met POS, Chrom en variant:
...
test3 <- list(SRR26980549_vcf$V2, SRR26980550_vcf$V2, SRR26980551_vcf$V2, SRR26980552_vcf$V2)

ggVennDiagram(x, set_color = c("green","yellow","black","purple"),
...
## **Discussie:** ##
Omdat de DNA-seq data niet gebruikt was in het originele onderzoek kunnen we de verkregen resultaten niet vergelijken met die van het onderzoek.
